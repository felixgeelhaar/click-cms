                        ...
                        'values' => [
                            ...
                            'plans' => [
                                [
                                    ...
                                    'features' => ['Collection and return', 'A written report before we start', 'Two-year guarantee on the repair'],
                                ],
                                [
                                    'title' => 'From the range',
                                    'price' => 'from £900',
                                    'summary' => 'One of our own designs, in the timber you choose.',
                                    'features' => ['Six-week lead time', 'Four timbers to choose from', '25-year structural guarantee'],
                                ],
                                [
                                    'title' => 'Commission',
                                    'price' => 'from £2,400',
                                    'summary' => 'Drawn for your room, and only your room.',
                                    'features' => ['A drawing and a fixed price first', 'Half on acceptance, half on delivery', '25-year structural guarantee'],
                                    'emphasis' => 'featured',
                                ],
                            ],
